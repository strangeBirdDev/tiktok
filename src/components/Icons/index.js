...
export const HomeSolidIcon = ({ width = "3.2rem", height = "3.2rem", className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const HomeRegularIcon = ({ width = "3.2rem", height = "3.2rem", className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const UsersSolidIcon = ({ width = "3.2rem", height = "3.2rem", className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const UsersRegularIcon = ({ width = "3.2rem", height = "3.2rem", className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const LiveSolidIcon = ({ width = "3.2rem", height = "3.2rem", className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const LiveRegularIcon = ({ width = "3.2rem", height = "3.2rem", className }) => (
    <svg
        className={className}
        width={width}
        height={height}
